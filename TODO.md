...
- [ ] Make GitHub issue-to-PR-to-merge a single durable objective loop, including automatic refresh, review/check ingestion, follow-up worker scheduling, and terminal satisfaction when merged.
- [ ] Add configurable PR policy for draft/ready state, branch naming, base detection, repo/fork selection, merge permissions, and whether aged may merge automatically.
